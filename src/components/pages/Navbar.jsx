...
const Navbar = () => {
  ...
  return (
    <header className="w-full shadow-md sticky top-0 z-50 my-5 bg-indigo-500 rounded-md overflow-hidden font-[Goldman]"
      data-aos="fade-down"
...
const NavLink = ({ to, children, active, ...props }) => (
  <Link
    to={to}
    className={`group relative block text-lg font-[Goldman] tracking-wide px-4 py-2 rounded overflow-hidden ${active ? 'bg-white text-indigo-600' : 'text-white'
      }`}
    {...props}
  >
