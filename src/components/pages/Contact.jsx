...
const Contact = () => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl sm:text-4xl font-[Goldman] tracking-[3px] uppercase font-bold text-center text-indigo-500 mb-10">
        Contact Me
      </h2>
      ...
      <div className="max-w-xl mx-auto bg-gray-100 p-6 sm:p-8 rounded-lg shadow-md">
        <form action="https://formspree.io/f/your-form-id" method="POST">
          ...
          <button
            type="submit"
            className="w-full sm:w-auto bg-indigo-600 text-white px-6 py-2 rounded hover:bg-indigo-700 transition-colors duration-200 text-sm sm:text-base"
          >
            Send Message
          </button>
        </form>
